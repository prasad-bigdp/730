  ...
  return (
		<div>
			<header className=' bg-black text-white-600 body-font'>
				<div className='container mx-auto flex flex-wrap p-2 sm:px-5 flex-col md:flex-row items-center'>
					...
					<nav className='md:ml-auto flex flex-wrap items-center text-base justify-center'>
						...
						<Link to='/products/all' className='mr-5 text-white hover:scale-105  hover:text-white-900'>Products</Link>
